...
export const anitaPapafrita: AnitaProject = {
  ...
  status: 'Próximamente',
  synopsis: `Ana emprende un viaje íntimo hacia su pasado, reviviendo los recuerdos y el vínculo con su madre, a quien vio por última vez cuando tenía seis años. 
  
  Ese momento marca un antes y un después en su vida, el cual se convierte en el motor de sus luchas y de su convicción por romper el silencio familiar sobre la desaparición de sus padres. 

  Entre recuerdos, anécdotas y una carta perdida, Ana busca comprender y resignificar aquello por lo que la familia tuvo
  que atravesar en una trama marcada por la ausencia y la persecución política.`,
  images: [
