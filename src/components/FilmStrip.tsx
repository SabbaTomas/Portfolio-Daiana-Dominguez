...
export default function FilmStrip({ projects, title }: Props) {
  return (
    <div>
      ...
      >
        {projects.map((project, i) => (
          <Link
            ...
            className="group flex-shrink-0 w-[280px] sm:w-[320px] md:w-[360px] snap-start rounded-xl overflow-hidden border transition-all hover:-translate-y-1 hover:shadow-2xl"
            style={{
